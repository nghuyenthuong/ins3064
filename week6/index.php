...
<div class="container">
   ...
   <!--visit https://www.w3schools.com/bootstrap/bootstrap_forms.asp search for forms template and use it.-->
    ...
    <form action="" name="form1" method="post">
        ...
        <button type="submit" name="delete" class="btn btn-default" onclick="Return comfirm">Delete</button>
...
<div class="col-lg-12">
    <table class="table table-bordered">
        ...
        while($row=mysqli_fetch_array($res))
        {
            ...
            echo "<td><a href='delete.php?id=" . $row["id"] . "' onclick='return confirm(\"Xóa bản ghi này?\");'><button type='button' class='btn btn-danger'>Delete</button></a></td>";
            echo "</tr>";
        }
        ?>
        </tbody>
